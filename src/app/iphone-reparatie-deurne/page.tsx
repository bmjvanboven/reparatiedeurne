...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const titel = "iPhone Reparatie Deurne – Scherm, Batterij & Camera";
  const description =
    "iPhone reparatie in Deurne: scherm vanaf €79, batterij vervangen vanaf €49. Vakkundig gerepareerd bij Telecombinatie, Wolfsberg 1. Bekijk direct de actuele prijzen.";

  return {
    title: titel,
    description,
    keywords: [
      "iPhone reparatie Deurne",
      "iPhone scherm reparatie Deurne",
      "iPhone scherm kapot Deurne",
      "iPhone batterij vervangen Deurne",
      "iPhone accu vervangen Deurne",
      "telefoon reparatie Deurne",
    ],
    alternates: {
      canonical: "/iphone-reparatie-deurne",
    },
...
const FAQS = [
  {
    vraag: "Wat kost een iPhone scherm reparatie in Deurne?",
    antwoord:
      "Een iPhone schermreparatie bij Telecombinatie Deurne kost tussen de €79 en €449 met een origineel scherm, afhankelijk van je model. Voor de meeste modellen bieden we ook een voordeliger namaakscherm aan. Bekijk de prijs van jouw model op onze reparatieprijzenpagina.",
  },
  {
    vraag: "Hoe lang duurt een iPhone reparatie bij Telecombinatie Deurne?",
    antwoord:
      "Je iPhone is bij Telecombinatie Deurne vaak dezelfde dag gerepareerd. Loop binnen op Wolfsberg 1 of neem vooraf contact op, dan kijken we samen naar de snelste oplossing.",
  },
  {
    vraag: "Waar kan ik mijn iPhone laten repareren in Deurne?",
    antwoord:
      "Bij Telecombinatie Deurne, Wolfsberg 1, 5751 GX Deurne. Je kunt gewoon binnenlopen of bellen via 0493 313307.",
  },
  {
    vraag: "Kan ik ook mijn iPhone batterij laten vervangen in Deurne?",
    antwoord:
      "Ja, een accu vervangen kost bij Telecombinatie Deurne tussen de €49 en €99, afhankelijk van je iPhone-model. Merk je dat je iPhone sneller leeg is dan vroeger, dan is een nieuwe batterij vaak de oplossing.",
  },
  {
    vraag: "Welke iPhone-modellen repareren jullie in Deurne?",
    antwoord:
...
export default async function IphoneReparatieDeurnePage() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10">
      ...
      <h1 className="text-2xl font-bold text-neutral-900 sm:text-3xl">iPhone reparatie in Deurne</h1>
      <p className="mt-4 max-w-2xl text-neutral-600">
        Bij Telecombinatie Deurne (Wolfsberg 1) is je iPhone vaak dezelfde dag gerepareerd. Een
      ...
      <section className="mt-12 rounded-xl border border-tc-paars bg-white p-6 shadow-sm">
        <h2 className="mb-2 text-lg font-bold text-tc-paars">Telecombinatie Deurne</h2>
