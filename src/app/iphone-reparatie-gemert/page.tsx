...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const titel = "iPhone Reparatie Gemert – Scherm, Batterij & Camera";
  const description =
    "iPhone reparatie in Gemert: scherm vanaf €79, batterij vervangen vanaf €49. Vakkundig gerepareerd bij Telecombinatie, Nieuwstraat 40a. Bekijk direct de actuele prijzen.";

  return {
    title: titel,
    description,
    keywords: [
      "iPhone reparatie Gemert",
      "iPhone scherm reparatie Gemert",
      "iPhone scherm kapot Gemert",
      "iPhone batterij vervangen Gemert",
      "iPhone accu vervangen Gemert",
      "telefoon reparatie Gemert",
    ],
    alternates: {
      canonical: "/iphone-reparatie-gemert",
    },
...
const FAQS = [
  {
    vraag: "Wat kost een iPhone scherm reparatie in Gemert?",
    antwoord:
      "Een iPhone schermreparatie bij Telecombinatie Gemert kost tussen de €79 en €449 met een origineel scherm, afhankelijk van je model. Voor de meeste modellen bieden we ook een voordeliger namaakscherm aan. Bekijk de prijs van jouw model op onze reparatieprijzenpagina.",
  },
  {
    vraag: "Hoe lang duurt een iPhone reparatie bij Telecombinatie Gemert?",
    antwoord:
      "Je iPhone is bij Telecombinatie Gemert vaak dezelfde dag gerepareerd. Loop binnen op Nieuwstraat 40a of neem vooraf contact op, dan kijken we samen naar de snelste oplossing.",
  },
  {
    vraag: "Waar kan ik mijn iPhone laten repareren in Gemert?",
    antwoord:
      "Bij Telecombinatie Gemert, Nieuwstraat 40a, 5421 KP Gemert. Je kunt gewoon binnenlopen of bellen via 0492 368 826.",
  },
  {
    vraag: "Kan ik ook mijn iPhone batterij laten vervangen in Gemert?",
    antwoord:
      "Ja, een accu vervangen kost bij Telecombinatie Gemert tussen de €49 en €99, afhankelijk van je iPhone-model. Merk je dat je iPhone sneller leeg is dan vroeger, dan is een nieuwe batterij vaak de oplossing.",
  },
  {
    vraag: "Welke iPhone-modellen repareren jullie in Gemert?",
    antwoord:
...
export default async function IphoneReparatieGemertPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10">
      ...
      <h1 className="text-2xl font-bold text-neutral-900 sm:text-3xl">iPhone reparatie in Gemert</h1>
      <p className="mt-4 max-w-2xl text-neutral-600">
        Bij Telecombinatie Gemert (Nieuwstraat 40a) is je iPhone vaak dezelfde dag gerepareerd. Een
      ...
      <section className="mt-12 rounded-xl border border-tc-paars bg-white p-6 shadow-sm">
        <h2 className="mb-2 text-lg font-bold text-tc-paars">Telecombinatie Gemert</h2>
